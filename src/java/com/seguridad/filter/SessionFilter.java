...
public class SessionFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        LoginUsuarioBean loginBean = (LoginUsuarioBean) req.getSession().getAttribute("loginUsuarioBean");
        ...
        if (loginBean == null || loginBean.getUsuario().getIdUsuario() == null) {
    ...
    private boolean noProteger(String urlStr) {
        ...
        if (urlStr.endsWith("/faces/resources/img/logo-draft.png")) {
            return true;
        }
        if (urlStr.endsWith("/faces/resources/img/bg2.png")) {
            return true;
        }
        if (urlStr.endsWith("/faces/resources/css/style.css")) {
            return true;
        }
        if (urlStr.endsWith("/faces/resources/img/tabstak.png")) {
            return true;
        }
        if (urlStr.endsWith("/faces/resources/img/logo.png")) {
            return true;
        }
        if (urlStr.endsWith("/faces/resources/img/user.png")) {
            return true;
        }
        if (urlStr.endsWith("/faces/resources/img/login.png")) {
            return true;
        }
        if (urlStr.endsWith("/faces/recordarpassword.xhtml")) {
            return true;
        }
        return false;
    }
